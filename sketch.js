...
function setup() {
  ...
  BoyAvatar = createSprite(200,350,100,100);
  BoyAvatar.addImage("boy",boyCharacter);
  GirlAvatar = createSprite(1275,350,100,100);
  GirlAvatar.addImage("girl",girlCharacter);

  BoyAvatar.visible = false;
  GirlAvatar.visible = false; 
}
...
function draw() {
  ...
  PlayGame.mousePressed(()=>{
    ...
    BoyAvatar.visible = true;
    GirlAvatar.visible = true;     
